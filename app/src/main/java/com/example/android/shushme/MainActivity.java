...
public class MainActivity extends AppCompatActivity implements
    ...
    private void refreshPlacesData() {
        String[] projection = {PlaceContract.PlaceEntry.COLUMN_PLACE_ID};
        ...
        PendingResult<PlaceBuffer> placeResult = Places.GeoDataApi.getPlaceById(apiClient,
                placeIds.toArray(new String[0]));
